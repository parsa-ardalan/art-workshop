...
export default function About() {
    ...
    return (
        ...
        <div className="w-full h-1/5 pt-4" id="about">

            <h1 className="text-black text-3xl text-center font-bold"> درباره ما </h1>

            <p className="text-black text-center text-xl w-5/6 mx-auto mt-3">
